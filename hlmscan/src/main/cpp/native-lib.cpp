...
Java_com_huifu_hlmscan_code_NativeSdk_createInstance(JNIEnv *env, jobject instance,
                                                      jintArray formats_) {
    try {
        if (javaCallHelper) {
...
Java_com_huifu_hlmscan_code_NativeSdk_setFormat(JNIEnv *env, jobject thiz, jlong objPtr,
                                                 jintArray formats_) {
    if (objPtr == 0) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huifu_hlmscan_code_NativeSdk_destroyInstance(JNIEnv *env, jobject instance,
                                                       jlong objPtr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huifu_hlmscan_code_NativeSdk_prepareRead(JNIEnv *env, jobject thiz, jlong objPtr) {
    auto imageScheduler = reinterpret_cast<ImageScheduler *>(objPtr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_huifu_hlmscan_code_NativeSdk_stopRead(JNIEnv *env, jobject thiz, jlong objPtr) {
    auto imageScheduler = reinterpret_cast<ImageScheduler *>(objPtr);
    imageScheduler->stop();
}
...
Java_com_huifu_hlmscan_code_NativeSdk_readBarcodeByte(JNIEnv *env, jobject instance, jlong objPtr,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huifu_hlmscan_code_NativeSdk_readBarcode(JNIEnv *env, jobject instance, jlong objPtr,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huifu_hlmscan_code_NativeSdk_writeCode(JNIEnv *env, jobject instance, jstring content_,
