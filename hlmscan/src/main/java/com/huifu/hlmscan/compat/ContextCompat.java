package com.huifu.hlmscan.compat;
...
public class ContextCompat {
    ...
    public static String getSystemServiceName( Context context,  Class<?> serviceClass) {
        return VERSION.SDK_INT >= 23 ? context.getSystemServiceName(serviceClass) : (String) LegacyServiceMapHolder.SERVICES.get(serviceClass);
    }
